...
- **7 interactive tabs** — leaderboard, top songs, fan map, trends, songs, comments, point economy
...
│   ├── tab_blowouts.py         # 🎵 Songs tab (blowouts, repeated songs, artist appearances)
...
### ❤️ Top Songs
- **By Total Points** — songs that earned the most points overall
- **By Number of Voters** — songs that received points from the most distinct voters
- Adjustable top-N slider (3–20)
